...
\restrict Qub6rZfsMqYv5oHyMIj0vhW04iIR0XvuBA2YZMkkz6jsom4hckOtmapDCJgfieP
...
CREATE TABLE public.api_tokens (
    ...
    expiry_notification_at timestamp with time zone
);
...
CREATE TABLE public.background_jobs (
    ...
    last_retry timestamp with time zone DEFAULT '1970-01-01 00:00:00'::timestamp without time zone NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
...
--
-- Name: cloudfront_invalidation_queue; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cloudfront_invalidation_queue (
    id bigint NOT NULL,
    path text NOT NULL,
...
--
-- Name: TABLE cloudfront_invalidation_queue; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.cloudfront_invalidation_queue IS 'Queue for batching CloudFront CDN invalidation requests';


--
-- Name: COLUMN cloudfront_invalidation_queue.id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.cloudfront_invalidation_queue.id IS 'Unique identifier for each queued invalidation path';


--
-- Name: COLUMN cloudfront_invalidation_queue.path; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.cloudfront_invalidation_queue.path IS 'CloudFront path to invalidate (e.g. /crates/serde/serde-1.0.0.crate)';


--
-- Name: COLUMN cloudfront_invalidation_queue.created_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.cloudfront_invalidation_queue.created_at IS 'Timestamp when the path was queued for invalidation';


--
-- Name: cloudfront_invalidation_queue_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.cloudfront_invalidation_queue_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: cloudfront_invalidation_queue_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.cloudfront_invalidation_queue_id_seq OWNED BY public.cloudfront_invalidation_queue.id;
...
--
-- Name: COLUMN crate_owner_invitations.expires_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN crates.trustpub_only; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.crates.trustpub_only IS 'When true, this crate can only be published via Trusted Publishing, not with API tokens';
...
--
-- Name: COLUMN default_versions.num_versions; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.default_versions.num_versions IS 'The total number of versions.';


--
-- Name: deleted_crates; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.deleted_crates (
    id integer NOT NULL,
    name character varying NOT NULL,
...
--
-- Name: TABLE deleted_crates; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.deleted_crates IS 'Crates that have been deleted by users';


--
-- Name: COLUMN deleted_crates.id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.deleted_crates.id IS 'Unique identifier of the `deleted_crates` row';


--
-- Name: COLUMN deleted_crates.name; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.deleted_crates.name IS 'Name of the deleted crate (use `canon_crate_name()` for normalization, if needed)';


--
-- Name: COLUMN deleted_crates.created_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.deleted_crates.created_at IS 'Date and time when the crate was created';


--
-- Name: COLUMN deleted_crates.deleted_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.deleted_crates.deleted_at IS 'Date and time when the crate was deleted';


--
-- Name: COLUMN deleted_crates.deleted_by; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.deleted_crates.deleted_by IS 'ID of the user who deleted the crate, or NULL if the user was deleted';


--
-- Name: COLUMN deleted_crates.message; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.deleted_crates.message IS 'Optional message left by the user who deleted the crate';


--
-- Name: COLUMN deleted_crates.available_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.deleted_crates.available_at IS 'Date and time when users will be able to create a new crate with the same name';


--
-- Name: deleted_crates_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.deleted_crates_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: deleted_crates_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.deleted_crates_id_seq OWNED BY public.deleted_crates.id;
...
CREATE TABLE public.versions (
    ...
    bin_names text[],
    yank_message text,
    num_no_build character varying NOT NULL,
    edition text,
    description text,
    homepage text,
    documentation text,
...
--
-- Name: COLUMN versions.has_lib; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.versions.has_lib IS 'TRUE if the version has a library (e.g. `src/lib.rs`), FALSE if no library was detected, or NULL if the version has not been analyzed yet.';


--
-- Name: COLUMN versions.bin_names; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.versions.bin_names IS 'list of the names of all detected binaries in the version. the list may be empty which indicates that no binaries were detected in the version. the column may be NULL is the version has not been analyzed yet.';


--
-- Name: COLUMN versions.yank_message; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.versions.yank_message IS 'message associated with a yanked version';


--
-- Name: COLUMN versions.num_no_build; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.versions.num_no_build IS 'This is the same as `num` without the optional "build metadata" part (except for some versions that were published before we started validating this).';


--
-- Name: COLUMN versions.edition; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.versions.edition IS 'The declared Rust Edition required to compile this version of the crate.';


--
-- Name: COLUMN versions.description; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.versions.description IS 'Value of the `description` field in the `Cargo.toml` file of this version.';


--
-- Name: COLUMN versions.homepage; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.versions.homepage IS 'Value of the `homepage` field in the `Cargo.toml` file of this version.';


--
-- Name: COLUMN versions.documentation; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.versions.documentation IS 'Value of the `documentation` field in the `Cargo.toml` file of this version.';


--
-- Name: COLUMN versions.repository; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.versions.repository IS 'Value of the `repository` field in the `Cargo.toml` file of this version.';


--
-- Name: COLUMN versions.categories; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.versions.categories IS 'The list of `categories` in the `Cargo.toml` file of this version.';


--
-- Name: COLUMN versions.keywords; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.versions.keywords IS 'The list of `keywords` in the `Cargo.toml` file of this version.';


--
-- Name: COLUMN versions.semver_ord; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.versions.semver_ord IS 'JSONB representation of the version number for sorting purposes.';


--
-- Name: COLUMN versions.trustpub_data; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.versions.trustpub_data IS 'JSONB data containing JWT claims from the trusted publisher (e.g., GitHub Actions context like repository, run_id, sha)';


--
-- Name: COLUMN versions.linecounts; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.versions.linecounts IS 'Source Lines of Code statistics for this version, stored as JSON with language breakdown and totals.';
...
--
-- Name: trustpub_configs_github; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.trustpub_configs_github (
    id integer NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    crate_id integer NOT NULL,
    repository_owner character varying NOT NULL,
    repository_owner_id integer NOT NULL,
    repository_name character varying NOT NULL,
    workflow_filename character varying NOT NULL,
    environment character varying
);


--
-- Name: TABLE trustpub_configs_github; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.trustpub_configs_github IS 'Trusted Publisher configuration for GitHub Actions';


--
-- Name: COLUMN trustpub_configs_github.id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_configs_github.id IS 'Unique identifier of the `trustpub_configs_github` row';


--
-- Name: COLUMN trustpub_configs_github.created_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_configs_github.created_at IS 'Date and time when the configuration was created';


--
-- Name: COLUMN trustpub_configs_github.crate_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_configs_github.crate_id IS 'Unique identifier of the crate that this configuration is for';


--
-- Name: COLUMN trustpub_configs_github.repository_owner; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_configs_github.repository_owner IS 'GitHub name of the user or organization that owns the repository';


--
-- Name: COLUMN trustpub_configs_github.repository_owner_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_configs_github.repository_owner_id IS 'GitHub ID of the user or organization that owns the repository';


--
-- Name: COLUMN trustpub_configs_github.repository_name; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_configs_github.repository_name IS 'Name of the repository that this configuration is for';


--
-- Name: COLUMN trustpub_configs_github.workflow_filename; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_configs_github.workflow_filename IS 'Name of the workflow file inside the repository that will be used to publish the crate';


--
-- Name: COLUMN trustpub_configs_github.environment; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_configs_github.environment IS 'GitHub Actions environment that will be used to publish the crate (if `NULL` the environment is unrestricted)';


--
-- Name: trustpub_configs_github_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.trustpub_configs_github_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trustpub_configs_github_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.trustpub_configs_github_id_seq OWNED BY public.trustpub_configs_github.id;


--
-- Name: trustpub_configs_gitlab; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.trustpub_configs_gitlab (
    id integer NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    crate_id integer NOT NULL,
    ...
    workflow_filepath character varying NOT NULL,
    environment character varying
);


--
-- Name: TABLE trustpub_configs_gitlab; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.trustpub_configs_gitlab IS 'Trusted Publisher configuration for GitLab CI';


--
-- Name: COLUMN trustpub_configs_gitlab.id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_configs_gitlab.id IS 'Unique identifier of the `trustpub_configs_gitlab` row';


--
-- Name: COLUMN trustpub_configs_gitlab.created_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_configs_gitlab.created_at IS 'Date and time when the configuration was created';


--
-- Name: COLUMN trustpub_configs_gitlab.crate_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_configs_gitlab.crate_id IS 'Unique identifier of the crate that this configuration is for';


--
-- Name: COLUMN trustpub_configs_gitlab.namespace; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_configs_gitlab.namespace IS 'GitLab namespace (user or group) that owns the project';


--
-- Name: COLUMN trustpub_configs_gitlab.namespace_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_configs_gitlab.namespace_id IS 'GitLab namespace ID, populated on first token exchange for resurrection attack protection';


--
-- Name: COLUMN trustpub_configs_gitlab.project; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_configs_gitlab.project IS 'Name of the GitLab project that this configuration is for';


--
-- Name: COLUMN trustpub_configs_gitlab.workflow_filepath; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_configs_gitlab.workflow_filepath IS 'Path to the CI/CD configuration file that will be used to publish the crate';


--
-- Name: COLUMN trustpub_configs_gitlab.environment; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_configs_gitlab.environment IS 'GitLab environment that will be used to publish the crate (if `NULL` the environment is unrestricted)';


--
-- Name: trustpub_configs_gitlab_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.trustpub_configs_gitlab_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trustpub_configs_gitlab_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.trustpub_configs_gitlab_id_seq OWNED BY public.trustpub_configs_gitlab.id;


--
-- Name: trustpub_tokens; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.trustpub_tokens (
    id bigint NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    expires_at timestamp with time zone NOT NULL,
    hashed_token bytea NOT NULL,
    crate_ids integer[] NOT NULL,
    trustpub_data jsonb
);


--
-- Name: TABLE trustpub_tokens; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.trustpub_tokens IS 'Temporary access tokens for Trusted Publishing';


--
-- Name: COLUMN trustpub_tokens.id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_tokens.id IS 'Unique identifier of the `trustpub_tokens` row';


--
-- Name: COLUMN trustpub_tokens.created_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_tokens.created_at IS 'Date and time when the token was created';


--
-- Name: COLUMN trustpub_tokens.expires_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_tokens.expires_at IS 'Date and time when the token will expire';


--
-- Name: COLUMN trustpub_tokens.hashed_token; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_tokens.hashed_token IS 'SHA256 hash of the token that can be used to publish the crate';


--
-- Name: COLUMN trustpub_tokens.crate_ids; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_tokens.crate_ids IS 'Unique identifiers of the crates that can be published using this token';


--
-- Name: COLUMN trustpub_tokens.trustpub_data; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_tokens.trustpub_data IS 'JSONB data containing JWT claims from the trusted publisher (e.g., GitHub Actions context like repository, run_id, sha)';


--
-- Name: trustpub_tokens_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.trustpub_tokens_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: trustpub_tokens_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.trustpub_tokens_id_seq OWNED BY public.trustpub_tokens.id;


--
-- Name: trustpub_used_jtis; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.trustpub_used_jtis (
    id bigint NOT NULL,
...
--
-- Name: TABLE trustpub_used_jtis; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.trustpub_used_jtis IS 'Used JWT IDs to prevent token reuse in the Trusted Publishing flow';


--
-- Name: COLUMN trustpub_used_jtis.id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_used_jtis.id IS 'Unique identifier of the `trustpub_used_jtis` row';


--
-- Name: COLUMN trustpub_used_jtis.jti; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_used_jtis.jti IS 'JWT ID from the OIDC token';


--
-- Name: COLUMN trustpub_used_jtis.used_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_used_jtis.used_at IS 'Date and time when the JWT was used';


--
-- Name: COLUMN trustpub_used_jtis.expires_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.trustpub_used_jtis.expires_at IS 'Date and time when the JWT would expire';


--
-- Name: trustpub_used_jtis_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.trustpub_used_jtis_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: trustpub_used_jtis_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.trustpub_used_jtis_id_seq OWNED BY public.trustpub_used_jtis.id;
...
CREATE TABLE public.users (
    ...
    gh_encrypted_token bytea NOT NULL
);


--
-- Name: COLUMN users.publish_notifications; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.users.publish_notifications IS 'Whether or not the user wants to receive notifications when a package they own is published';


--
-- Name: COLUMN users.gh_encrypted_token; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.users.gh_encrypted_token IS 'Encrypted GitHub access token';
...
--
-- Name: cloudfront_invalidation_queue id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cloudfront_invalidation_queue ALTER COLUMN id SET DEFAULT nextval('public.cloudfront_invalidation_queue_id_seq'::regclass);
...
--
-- Name: deleted_crates id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.deleted_crates ALTER COLUMN id SET DEFAULT nextval('public.deleted_crates_id_seq'::regclass);
...
--
-- Name: trustpub_configs_github id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trustpub_configs_github ALTER COLUMN id SET DEFAULT nextval('public.trustpub_configs_github_id_seq'::regclass);


--
-- Name: trustpub_configs_gitlab id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trustpub_configs_gitlab ALTER COLUMN id SET DEFAULT nextval('public.trustpub_configs_gitlab_id_seq'::regclass);


--
-- Name: trustpub_tokens id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trustpub_tokens ALTER COLUMN id SET DEFAULT nextval('public.trustpub_tokens_id_seq'::regclass);


--
-- Name: trustpub_used_jtis id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trustpub_used_jtis ALTER COLUMN id SET DEFAULT nextval('public.trustpub_used_jtis_id_seq'::regclass);
...
--
-- Name: cloudfront_invalidation_queue cloudfront_invalidation_queue_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cloudfront_invalidation_queue
    ADD CONSTRAINT cloudfront_invalidation_queue_pkey PRIMARY KEY (id);
...
--
-- Name: deleted_crates deleted_crates_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.deleted_crates
    ADD CONSTRAINT deleted_crates_pkey PRIMARY KEY (id);
...
--
-- Name: trustpub_configs_github trustpub_configs_github_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trustpub_configs_github
    ADD CONSTRAINT trustpub_configs_github_pkey PRIMARY KEY (id);


--
-- Name: trustpub_configs_gitlab trustpub_configs_gitlab_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trustpub_configs_gitlab
    ADD CONSTRAINT trustpub_configs_gitlab_pkey PRIMARY KEY (id);


--
-- Name: trustpub_tokens trustpub_tokens_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trustpub_tokens
    ADD CONSTRAINT trustpub_tokens_pkey PRIMARY KEY (id);


--
-- Name: trustpub_used_jtis trustpub_used_jtis_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trustpub_used_jtis
    ADD CONSTRAINT trustpub_used_jtis_pkey PRIMARY KEY (id);
...
--
-- Name: background_jobs_priority_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX background_jobs_priority_id_index ON public.background_jobs USING btree (priority DESC, id);
...
--
-- Name: deleted_crates_canon_crate_name_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX deleted_crates_canon_crate_name_index ON public.deleted_crates USING btree (public.canon_crate_name((name)::text));
...
--
-- Name: idx_cloudfront_invalidation_queue_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_cloudfront_invalidation_queue_created_at ON public.cloudfront_invalidation_queue USING btree (created_at);


--
-- Name: idx_trustpub_configs_github_repo; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_trustpub_configs_github_repo ON public.trustpub_configs_github USING btree (lower((repository_owner)::text), lower((repository_name)::text));
...
--
-- Name: trustpub_tokens_hashed_token_uindex; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX trustpub_tokens_hashed_token_uindex ON public.trustpub_tokens USING btree (hashed_token);


--
-- Name: trustpub_used_jtis_jti_uindex; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX trustpub_used_jtis_jti_uindex ON public.trustpub_used_jtis USING btree (jti);
...
--
-- Name: versions_crate_id_num_no_build_uindex; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX versions_crate_id_num_no_build_uindex ON public.versions USING btree (crate_id, num_no_build);


--
-- Name: versions_id_yanked_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX versions_id_yanked_idx ON public.versions USING btree (id) WHERE yanked;


-- MODIFIED
CREATE INDEX versions_created_at_index ON public.versions USING btree (created_at DESC, id);
-- CREATE INDEX versions_downloads ON public.versions USING btree (downloads DESC, id);
...
--
-- Name: versions trigger_set_semver_ord; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_set_semver_ord BEFORE INSERT ON public.versions FOR EACH ROW EXECUTE FUNCTION public.set_semver_ord();
...
--
-- Name: versions trigger_update_num_versions_from_versions; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_update_num_versions_from_versions AFTER INSERT OR DELETE ON public.versions FOR EACH ROW EXECUTE FUNCTION public.update_num_versions_from_versions();
...
--
-- Name: CONSTRAINT default_versions_crates_id_fk ON default_versions; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON CONSTRAINT default_versions_crates_id_fk ON public.default_versions IS 'This is a `cascade` delete because we want to delete the row when the crate is deleted.';
...
ALTER TABLE ONLY public.default_versions
    ADD CONSTRAINT default_versions_versions_id_fk FOREIGN KEY (version_id) REFERENCES public.versions(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: CONSTRAINT default_versions_versions_id_fk ON default_versions; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON CONSTRAINT default_versions_versions_id_fk ON public.default_versions IS 'This is a `no action` delete because we want to fail the version deletion unless the default version is updated in the same transaction.';


--
-- Name: deleted_crates deleted_crates_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.deleted_crates
    ADD CONSTRAINT deleted_crates_users_id_fk FOREIGN KEY (deleted_by) REFERENCES public.users(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.crates_keywords
    ADD CONSTRAINT fk_crates_keywords_keyword_id FOREIGN KEY (keyword_id) REFERENCES public.keywords(id) ON DELETE CASCADE;
...
--
-- Name: trustpub_configs_github trustpub_configs_github_crate_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trustpub_configs_github
    ADD CONSTRAINT trustpub_configs_github_crate_id_fkey FOREIGN KEY (crate_id) REFERENCES public.crates(id) ON DELETE CASCADE;


--
-- Name: trustpub_configs_gitlab trustpub_configs_gitlab_crate_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trustpub_configs_gitlab
    ADD CONSTRAINT trustpub_configs_gitlab_crate_id_fkey FOREIGN KEY (crate_id) REFERENCES public.crates(id) ON DELETE CASCADE;
...
\unrestrict Qub6rZfsMqYv5oHyMIj0vhW04iIR0XvuBA2YZMkkz6jsom4hckOtmapDCJgfieP
